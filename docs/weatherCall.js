function weatherCall (...param) {

fetch(...param.length === 1 ?
    'https://api.openweathermap.org/data/2.5/weather?q=' + inputValue.value + '&APPID=530df0912db9cd46a24db04211fd0b82' :
    'https://api.openweathermap.org/data/2.5/weather?lat=' +inputValue.value + '&APPID=530df0912db9cd46a24db04211fd0b82' 
    )
